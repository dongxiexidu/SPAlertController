...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SPAlertController",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC17SPAlertController13SPAlertAction")
@interface SPAlertAction : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


@interface SPAlertAction (SWIFT_EXTENSION(SPAlertController)) <NSCopying>
...
SWIFT_CLASS("_TtC17SPAlertController17SPAlertController")
...
@interface SPAlertController (SWIFT_EXTENSION(SPAlertController))
